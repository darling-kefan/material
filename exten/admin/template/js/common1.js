	...
	$.fn.extend({
		browser: function(options) {
			var settings = {
				...
				isUpload: true,
				browserUrl: shopxx.base + "admin.php?app=materialTable&act=sqlFileList",
				uploadUrl: shopxx.base + "admin.php?app=materialTable&act=uploadSQL",
				callback: null
			};
			$.extend(settings, options);
